...
public class ExtentReportManager implements ITestListener {
	...
	public ExtentSparkReporter sparkReporter; //Responsible for Look&Feel of the report
	public ExtentReports extent; // to specify the common information
	public ExtentTest test; // to report pass,fail, skipped
	...
	public void onStart(ITestContext testContext)
	{
		...
		extent.setSystemInfo("user", "Saraswat");
